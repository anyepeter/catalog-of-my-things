...
**[Catalog of my things]** Catalog of my things is a console app to showcase everything in my catalog (games, movies, music and books)
...
```sh
  cd my-folder
  git https://github.com/anyepeter/catalog-of-my-things.git
```
