...
describe MusicAlbum do
  before(:all) do
    @album1 = MusicAlbum.new('test1', Date.parse('11-11-2020'), true)
    @album2 = MusicAlbum.new('test2', Date.parse('11-11-2000'), true)
    @album3 = MusicAlbum.new('test3', Date.parse('11-11-2000'), false)
  end
